...
class ProductsFixture extends TestFixture
{
    ...
    public array $fields = [
        ...
        'stock' => ['type' => 'integer', 'length' => null, 'unsigned' => true, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        'status' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'active', 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'autoCreate' => null, 'extra' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'stock' => 100,
                'status' => 'active',
                'created' => '2026-03-05 16:58:57',
                'modified' => '2026-03-05 16:58:57',
            ],
            [
                'id' => 2,
                'name' => 'Product 2',
